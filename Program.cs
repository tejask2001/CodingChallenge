...
builder.Services.AddScoped<IRepository<int, Participant>, ParticipantRepository>();
builder.Services.AddScoped<IRepository<int, EventParticipant>, EventParticipantRepository>();
